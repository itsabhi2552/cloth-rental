...
function BlockedProducts() {
  ...
  function unblockCloth(i){
    let token=localStorage.getItem("token");
    fetch("http://localhost:3000/unblock_cloth", {
    method: "POST",
    ...
    useEffect(()=>{
        let token=localStorage.getItem("token");
        fetch("http://localhost:3000/blocked_cloth", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
    ...
    <div className='row '>
      ...
      <div className='col'>
            <div className="px-3">
                ...
                <span className="text-white fs-4">Blocked Products</span>
            </div>
                            ...
                            return(
                                <>
                                    ...
                                    /></td>
                                        ...
                                        <td><button className="btn btn-danger" onClick={()=>unblockCloth(index)} >unblock</button></td>
                                    </tr>
                                </>
                            )
                        })
