...
function ActiveUsers() {
  ...
  const [AllUser,setAllUser]=useState([]);
    ...
    function blockUser(i){
        ...
        fetch("http://localhost:3000/block_user", {
        method: "POST",
    ...
    useEffect(()=>{
        let token=localStorage.getItem("token");
        fetch("http://localhost:3000/active_user", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
    ...
    <div className='row '>
      ...
      <div className='col'>
            <div className="px-3">
                ...
                <span className="text-white fs-4">Active Users</span>
            </div>
                            ...
                            return(
                                <>
                                    <tr key={index}>
                                        ...
                                        <td>{item.address}</td>
                                        <td><button className="btn btn-danger" onClick={()=>blockUser(index)}>Block</button></td>
                                    </tr>
                                </>
                            )
                        })
