...
function ActiveSellers(i) {
  ...
  function blockSeller(i){
    ...
    fetch("http://localhost:3000/block_seller", {
    method: "POST",
    ...
    useEffect(()=>{
        let token=localStorage.getItem("token");
        fetch("http://localhost:3000/active_seller", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
    ...
    <div className='row '>
      ...
      <div className='col'>
            <div className="px-3">
                ...
                <span className="text-white fs-4">Active Sellers</span>
            </div>
                            ...
                            return(
                                <>
                                    <tr key={index}>
                                        ...
                                        <td>{item.address}</td>
                                        <td><button className="btn btn-danger" onClick={()=>blockSeller(index)}>Block</button></td>
                                    </tr>
                                </>
                            )
                        })
