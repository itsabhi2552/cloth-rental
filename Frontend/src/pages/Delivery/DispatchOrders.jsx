...
function DispatchOrders() {
  ...
  function OnTheWay(i){
    ...
    fetch("http://localhost:3000/on_the_way_order", {
    method: "POST",
    ...
    useEffect(()=>{
        let token=localStorage.getItem("token");
        fetch("http://localhost:3000/get_dispatched_orders", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
    ...
    <div className='row '>
      ...
      <div className='col'>
            <div className="px-3">
                ...
                <span className="text-white fs-4">All Dispatch Orders</span>
            </div>
                            ...
                            return(
                                <>
                                    <tr key={index}>
                                        ...
                                        <td><button className="btn btn-danger" onClick={()=>OnTheWay(index)}>OnTheWay</button></td>
                                    </tr>
                                </>
                            )
                        })
